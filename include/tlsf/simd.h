...
/// `-m` flag makes the compiler predefine __AVX512F__ / __AVX2__ / __ARM_NEON,
/// which selects the corresponding branch below.  Every kernel has a portable
/// scalar fallback, so omitting -Dcpu (baseline) is always correct.
///
