...
NATIVE_API = "test/api/native_api_c"
...
cases = ROOT / "test" / "fixtures" / "cases"
...
provenance.unlink()
direct = invoke(BUILD, NATIVE_API, "--expand", cases / "expand_demo.tlsf",
                provenance)
...
for label, game, expected in (("real", real, 0),
    ...
    prefix = WORK / "direct"
    direct = invoke(BUILD, NATIVE_API, "--export", game, certificate,
                    policy, prefix)
