...
Raw per-instance variants can be regenerated with the same invocation plus
`--data docs/benchgraph/RUN.tsv` and the desired repeated
`--compose-extra-arg` options.
